import { MessageRecord, PipelineResult, RawMessageRecord } from "@azure/swagger-validation-common";
import { CodegenPipelineTaskResult } from "./PipelineTask";
import * as yaml from "node-yaml";

export function GenerateCodeGenerateResult(logfile: string, pipelineResultLog: string) {
    const fs = require("fs");
    ...
    let result: CodegenPipelineTaskResult = {
        ...
        pipelineId: "",
        status: "completed",
        result: errorNum <= 0 ? "success" : "failure",
        errorCount: errorNum,
...
GenerateCodeGenerateResult("GenerateJob.log", "pipe.log");