...
export async function ReadCustomizeFiles(
  token: string,
  org: string,
  repo: string,
  prNumber: number,
...
export async function DeleteFilesFromRepo(
  token: string,
  org: string,
  repo: string,
  branch: string,
...
/* list pull request. */
export async function listOpenPullRequest(
  token: string,
  org: string,
  repo: string,
  head: string,
...
export async function IsMergedPullRequest(
  token: string,
  prlink: string
): Promise<boolean> {
