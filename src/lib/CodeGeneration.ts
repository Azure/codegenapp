...
import { StageUpdateType } from "azure-devops-node-api/interfaces/BuildInterfaces";
...
export async function SubmitSDKCodeGeneration(
...
export async function getSDKCodeGeneration(
  credential: DBCredential,
  resourceProvider: string,
  sdk: string,
  type: string
...
export async function getSDKCodeGenerationByName(
  credential: DBCredential,
  name: string
): Promise<{ codegen: SDKCodeGeneration; err: any }> {
  // let codegens: CodeGeneration[] = [];
...
/* update code-gen information. */
export async function UpdateSDKCodeGenerationValue(
  credential: DBCredential,
  name: string,
  key: string,
  value: string
...
/* update code-gen information. */
export async function UpdateSDKCodeGenerationValues(
  credential: DBCredential,
  name: string,
  values: {}
): Promise<any> {
...
export async function ExistValidSDKCodeGeneration(
  credential: DBCredential,
  name: string,
  type: string
): Promise<boolean> {
...
/*Get all code generations of an special onboard type. */
export async function ListSDKCodeGenerations(
  credential: DBCredential,
  type: string,
  filterCompleted: boolean = false
