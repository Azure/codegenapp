...
export enum CodeGenerationDBColumn {
  CODE_GENERATION_COLUMN_NAME = "name",
  CODE_GENERATION_COLUMN_RESOURCE_PROVIDER = "resourceProvider",
  CODE_GENERATION_COLUMN_SERVICETYPE = "serviceType",
  ...
  CODE_GENERATION_COLUMN_SWAGGERREPO = "swaggerRepo",
  CODE_GENERATION_COLUMN_SDKREPO = "sdkRepo",
  CODE_GENERATION_COLUMN_CODEGENREPO = "codegenRepo",
  CODE_GENERATION_COLUMN_TYPE = "type",
  CODE_GENERATION_COLUMN_IGNOAREFAILURE = "ignoreFailure",
  CODE_GENEERTION_COLUMN_STAGES = "stages",
  CODE_GENERATION_COLUMN_PIPELINEBUILDID = "lastPipelineBuildID",
  ...
  CODE_GENERATION_COLUMN_OWNER = "owner",
}
